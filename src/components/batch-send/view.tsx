...
import FromInput from '../send/components/from-input';
import { RecepientDetailDiv, TransactionDetailDiv, Divider } from './styles';
...
const BatchSendView: React.FunctionComponent = () => {
